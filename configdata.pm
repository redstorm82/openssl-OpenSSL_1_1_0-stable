...
our %config = (
  ...
  cross_compile_prefix => "/opt/ndk/android-ndk-r13b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-",
  ...
  perl => "/usr/bin/perl",
  perlargv => [ "android-armeabi", "no-asm", "--prefix=/home/shenshaohui/openssl-install/arm", "--cross-compile-prefix=/opt/ndk/android-ndk-r13b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-" ],
  prefix => "/home/shenshaohui/openssl-install/arm",
  processor => "",
